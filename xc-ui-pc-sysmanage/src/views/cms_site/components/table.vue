<template>
    <div>
        ...
        <el-table :data="list" highlight-current-row v-loading="listLoading" :span="24" size="small">
            ...
            <el-table-column prop="siteName" label="站点名称" width="130">
            </el-table-column>
            <el-table-column prop="siteDomain" label="主机" width="230">
            </el-table-column>
            <el-table-column prop="sitePort" label="端口" width="80">
            </el-table-column>
            <el-table-column prop="siteWebPath" label="访问路径" width="80">
            </el-table-column>
            <el-table-column prop="sitePhysicalPath" label="物理路径">
            </el-table-column>
            <el-table-column prop="siteCreateTime" label="创建时间" :formatter="formatCreatetime" width="145">
            </el-table-column>
