...
import course_marketinfo from '@/views/course/page/course_manage/course_marketinfo.vue';
import course_teacher from '@/views/course/page/course_manage/course_teacher.vue';
import course_plan from '@/views/course/page/course_manage/course_plan.vue';
import course_pub from '@/views/course/page/course_manage/course_pub.vue';
export default [
{
    path: '/course',
    component: Home,
